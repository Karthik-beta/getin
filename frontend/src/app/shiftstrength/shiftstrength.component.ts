...
@Component({
  selector: 'app-shiftstrength',
  templateUrl: './shiftstrength.component.html',
  styleUrls: ['./shiftstrength.component.css']
})
export class ShiftstrengthComponent implements OnInit, OnDestroy {
  currentShift: string = '';
